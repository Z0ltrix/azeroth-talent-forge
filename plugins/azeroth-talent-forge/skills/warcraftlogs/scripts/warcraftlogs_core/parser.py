...
def build_parser() -> argparse.ArgumentParser:
    ...
    compare_parsers = compare.add_subparsers(dest="kind")
    actor_compare = compare_parsers.add_parser("actor-metrics")
    actor_compare.add_argument("target")
    actor_compare.add_argument("reference")
    actor_compare.add_argument("--output")
