...
```powershell
python scripts\wowhead_assets.py "https://www.wowhead.com/talent-calc/blizzard/..." --json
```
...
```powershell
python -B scripts\wowhead_talent_builder.py --base "https://www.wowhead.com/talent-calc/blizzard/..." --set "Talent Name" --clear "Talent Name"
```

For custom swaps:

```powershell
python -B scripts\wowhead_talent_builder.py --base "https://www.wowhead.com/talent-calc/blizzard/..." --clear "Old Talent Name" --set "New Talent Name" --choice "Choice Node Name=Choice Name"
```
